...
public class AccessibilityNodeInfoDumper {
    ...
    private static final String LOGTAG = "AccessibilityNodeInfoDumper"/*android.support.test.uiautomator.AccessibilityNodeInfoDumper.class.getSimpleName()*/;
    ...
    public static String dumpWindowHierarchy(UiDevice device/*, OutputStream out*/) throws IOException {
        ...
        //for (AccessibilityNodeInfo root : getWindowRoots()) {
        //  System.out.println("Debug: getWindowRoots");
        if (root != null)   dumpNodeRec(root, serializer, 0, device.getDisplayWidth(), device.getDisplayHeight());
        //}
    ...
    private static boolean childNafCheck(AccessibilityNodeInfo node) {
        ...
        for (int x = 0; x < childCount; x++) {
            ...
            if (childNode != null && (!safeCharSeqToString(childNode.getContentDescription()).isEmpty()
